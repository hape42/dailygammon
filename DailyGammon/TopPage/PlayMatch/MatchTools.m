...
@synthesize design, rating,tools, boardElements, exportPosition;
...
-(NSMutableDictionary *)drawBoard:(int)schema boardInfo:(NSMutableDictionary *)boardDict boardView:(UIView *)boardView zoom:(float)zoomFactor isReview:(BOOL) isReview
{
    ...
    exportPosition = [[ExportPosition alloc] init];
...
#pragma mark - Dices
    ...
    [idButton.layer setValue:[exportPosition makePositionsID] forKey:@"posID"];
    [idButton.layer setValue:[exportPosition makeMatchID] forKey:@"matchID"];
