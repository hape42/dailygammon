...
//    barLineChart.plotAreaFrame.borderWidth = 1;
    ...
    barLineChart.plotAreaFrame.paddingBottom = 10.0;
    ...
    hostingView = [[CPTGraphHostingView alloc] initWithFrame:CGRectMake(0, 40, maxWidth, maxHeight)];
...
//    graph.legendDisplacement = CGPointMake(0.0, 50.0);
