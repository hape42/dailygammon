...
#define POOLBREITE 86
#define ROUNDBREITE  50
#define LENGTHBREITE  70
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    int nummerBreite = NUMMERBREITE;
    int graceBreite = GRACEBREITE;
    int poolBreite = POOLBREITE;
    int roundBreite = ROUNDBREITE;
    int lengthBreite = LENGTHBREITE;
